...
<main>
    <div class="container-fluid">
                ...
                <div class="col">
                    ...
                    <div class="row" class="">
                        ...
                        <input name="snf" id="farmer_snf" type="text" class="col-sm my-1 mx-2 form-control text-center"
                               value="0" placeholder="Enter Snf" required>
        ...
        <div class="row">        
            <div class="col">
                <div class="alert alert-success d-none" id="danger-alert">
        ...
        <div class="row">
            <div class="col-12">
                <table id='dtBasicExample' class='table table-sm bg-white text-dark table-striped table-bordered'>
                    <thead>
                    <tr>
                        <th class='th-sm'>SNO
                    ...
                    <tr id="edit-<%=resultSet.getInt("farmer_id")%>">
                        <td class="" style=font-size:1.1rem;><%=resultSet.getInt("Serial_no")%>
                        </td>
                        ...
                        <td style="font-size:1.1rem;">
                            <div class="row ml-1 w-75 ">
                                    <div class="col  text-center view overlay zoomIn">
                                ...
                                <div class="col  text-center view overlay zoomIn">
                                        <a onclick="deleteData(<%=resultSet.getInt("farmer_id")%>)">
                                            <i class="fa text-danger fa-times"></i>
                                            <div class="mask flex-center danger-color">
