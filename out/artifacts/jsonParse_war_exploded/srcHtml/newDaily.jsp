...
<div class="container-fluid mt-2">
       <form method="post" class="cons" action="#">

        <div class="card rgba-teal-strong">
            <div class="card-body ">
              <div class="form-row mb-3">
                  <div class="col-sm text-white text-center"><strong>S.no</strong></div>
                  <div class="col-sm text-white text-center"><strong>Name</strong></div>
                  <div class="col-sm text-white text-center"><strong>Shift</strong></div>
                  <div class="col-sm text-white text-center"><strong>Date</strong></div>
              </div>  
              <div class="form-row hr-light pt-3 p-5">
                <input  name="serial_no"    id="serial_no"     type="number"  class="col-sm form-control "  placeholder="S.No"  min="0" value="<%=session.getAttribute("sno")%>" >
                <input  name="farmer_name"  id="farmer_name"   type="text"    class="col-sm form-control "  placeholder="Farmer Name" readonly >
                <select name="shift"        id="shift"                        class="col-sm "               onchange="loadDoc()">
                ...
                <input name="dailyDate"     id="dailyDate"    type="date"     class="col-sm"    value="<%=session.getAttribute("date")%>" onchange="loadDoc();" class="form-control " >
              </div>
            </div>
        </div>
        <div class="card rgba-teal-strong">
            <div class="card-body ">
              <div class="form-row mb-3">
                  <div class="col-sm text-white text-center"><strong>Code</strong></div>
                  <div class="col-sm text-white text-center"><strong>Qty.</strong></div>
                  <div class="col-sm text-white text-center"><strong>Fat</strong></div>
                  <div class="col-sm text-white text-center"><strong>Snf</strong></div>
                  <div class="col-sm text-white text-center"><strong>Milk Rate</strong></div>
                  <div class="col-sm text-white text-center"><strong></strong>Amount</div>
                  <div class="col-sm text-white text-center"><strong></strong>Insert</div>
              </div>  
              <div class="form-row hr-light pt-3 p-5">
                <input name="farmer_id"    id="farmer_id"    type="text"  class="col-sm  form-control mx-2 border border-info"     placeholder="Farmer ID" >
                <input name="qty"          id="qty"          type="text"  class="col-sm  form-control mx-2 border border-info"     placeholder="Milk Quantity"              onchange="multiply()" >
                <input name="fat"          id="fat"          type="text"  class="col-sm  form-control mx-2 border border-info"     placeholder="Milk Fat"      value="0"    onchange="multiply()" >
                <input name="snf"          id="snf"          type="text"  class="col-sm  form-control mx-2 border border-info"     placeholder="Milk snf"      value="0"  >
                <input name="MilkRate"     id="MilkRate"     type="text"  class="col-sm  form-control mx-2 border border-info"      placeholder="Milk Rate"                  onchange="multiply()" >
                ...
                <button type="submit" class="btn btn-primary my-0">Insert Data</button>
              </div>
            </div>
        </div>
    </form>
